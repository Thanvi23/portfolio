  ...
  const jobs = [
    {
      ...
      bullets: [
        'Contributed to backend development of ExamProMax - Online Learning & Examination Platform',
        'Implemented APIs for Super Admin and Admin management, organization creation and configuration',
        'Developed exam workflow modules supporting scheduling, candidate management, and automated result processing',
        'Built real-time functionalities using WebSockets and Redis for live chat and exam status updates',
        'Tech Stack: Node.js, Express.js, PostgreSQL, Redis, WebSockets, REST APIs, JWT',
      ],
    },
    {
      ...
      bullets: [
        'Developed backend modules for TechLife HRM Employee Management System',
        'Designed and implemented RESTful APIs using Spring Boot and MySQL',
        'Built real-time ticketing system using Apache Kafka and Redis Pub/Sub for notifications',
        'Ensured data consistency, security, and backend performance optimization',
        'Tech Stack: Java, Spring Boot, MySQL, Kafka, Redis, REST APIs, JWT',
      ],
    },
  ]
  ...
  const edu = [
    {
      ...
      duration: '2021 – 2025',
      extra: 'CGPA: 7.1',
      note: 'Focused on full-stack development and system design',
      color: '#06b6d4',
    },
    {
      ...
      location: 'Hyderabad, India',
      duration: '2019 – 2021',
      extra: 'Percentage: 84.4%',
      color: '#8b5cf6',
    },
    {
      title: 'Class X (SSC)',
      school: 'Secondary Education Board',
      location: 'Hyderabad, India',
      duration: '2019',
      extra: 'GPA: 9.5',
      color: '#10b981',
