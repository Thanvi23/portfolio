      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid sm:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm leading-relaxed">DevOps Engineer automating infrastructure and building scalable cloud solutions.</p>
          </div>
          ...
          {[
                ...
                { icon: Link, href: 'https://linkedin.com/in/eswar-santhosh', label: 'LinkedIn' },
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8"
          ...
          <p className="text-slate-600 text-sm flex items-center gap-1.5">
            © 2025 Eswar Santhosh · Made with <Heart size={13} className="text-red-500" /> in Vijayawada
          </p>
